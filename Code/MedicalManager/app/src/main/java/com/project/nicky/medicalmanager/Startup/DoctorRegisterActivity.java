...
public class DoctorRegisterActivity extends AppCompatActivity implements BackgroundResponse {

    private EditText firstNameField, lastNameField, usernameField, passwordField, backgroundField, qualificationsField, experienceField, addressLineField, cityField, countyField;
    private Spinner countrySpinner;
    private ArrayAdapter arrayAdapter;
    String firstName, lastName, username, password, background, qualifications, experience, addressLine, city, county, country;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backgroundField = (EditText)findViewById(R.id.backgroundField);
        qualificationsField = (EditText)findViewById(R.id.qualificationsField);
        experienceField = (EditText)findViewById(R.id.experienceField);
    ...
    public void registerButtonClicked(View view) {
        ...
        background = backgroundField.getText().toString();
        qualifications = qualificationsField.getText().toString();
        ...
        validation.checkIfEmpty(background, backgroundField, "Background cannot be empty");
        validation.checkIfEmpty(qualifications, qualificationsField, "Qualifications cannot be empty");
        validation.validate(Validation.NUMBERS, experience, experienceField, "Experience cannot be empty", "Experience must be a whole number");
        ...
        if (validation.counter == 0) {
            String type = "registerDoctor";
            BackgroundTask backgroundTask = new BackgroundTask(this);
            backgroundTask.backgroundResponse = this;
            backgroundTask.execute(type, firstName, lastName, username, password, background, qualifications, experience, addressLine, city, county, country);
        }
    }
